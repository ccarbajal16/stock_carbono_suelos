...
wcs = WebCoverageService('https://maps.isric.org/mapserv?map=/map/ocs.map', version='1.0.0') #! Se emplea el ocs (Soil organic carbon stock)
#TODO Incorporar un cuadro delimitador que coincida para el ejemplo con la Región Junín del Perú
